...
from preprocess.price_plot import LSTM_plot  # Note: You may want to rename this import/function to something more generic like RNN_plot
...
def RNN_fit(filtered_data):
    ...
    # Reshaping the input to be [samples, time steps, features] which is required for RNN
    ...
    model = Sequential([
        SimpleRNN(64, return_sequences=True, input_shape=(60, feature_count)),
    ...
    # Rescale y_test to its original values for comparison
    ...
    # You may want to rename this plotting function
